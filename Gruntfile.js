...
module.exports = function (grunt) {
  ...
  var jsFilesToInject = [
    ...
    'linker/js/lib/json2.js',
    'linker/js/lib/underscore.js',
    'linker/js/lib/backbone.js',
    'linker/js/lib/backbone.wreqr.js',
    'linker/js/lib/backbone.babysitter.js',
    'linker/js/lib/backbone.marionette.js',
